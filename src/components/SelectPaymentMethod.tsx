...
var TransferImage = require('../assets/images/transfer.png');
var ConnectImage = require('../assets/images/WalletConnect.png');
var Cancel = require('../assets/images/cancel.png');
